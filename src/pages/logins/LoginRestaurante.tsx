    ...
    <>
      ...
      <main className="relative min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-50 px-4 py-10">
        <button
          ...
          className="absolute left-4 top-4 sm:left-6 sm:top-6 flex items-center gap-1.5 rounded-full border-2 border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-600 shadow-sm transition-all hover:border-trego-restaurante hover:text-trego-restaurante active:scale-95"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
